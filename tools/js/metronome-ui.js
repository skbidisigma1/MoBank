...
async function refreshBackendPresets(force=false){const cached=getCachedPresets();if(cached&&!force){backendPresetsCache=cached;return}backendPresetsCache=await fetchUserPresets();setCachedPresets(backendPresetsCache)}function getUserPresets(){return backendPresetsCache}
